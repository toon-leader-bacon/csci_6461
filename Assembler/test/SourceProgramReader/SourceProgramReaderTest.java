...
class SourceProgramReaderTest {
    ...
    */
    ...
    void runExampleInputFile() {
        SourceProgramReader underTest = new SourceProgramReader();
        underTest.OpenAndReadSourceProgramFile("/Users/nocab/Projects/School/CompArch/csci_6461/NocabMachine/src/test/java/org/nocab/nocabmachine/nocab/SourceProgram.txt",
                true);
    ...
    void allCommandsInputFile() {
        SourceProgramReader underTest = new SourceProgramReader();
        underTest.OpenAndReadSourceProgramFile("/Users/nocab/Projects/School/CompArch/csci_6461/NocabMachine/src/test/java/org/nocab/nocabmachine/nocab/AllCommands.txt",
                true);
    }
    ...
    void evenMoreCommandsInputFile() {
        SourceProgramReader underTest = new SourceProgramReader();
        underTest.OpenAndReadSourceProgramFile("/Users/nocab/Projects/School/CompArch/csci_6461/NocabMachine/src/test/java/org/nocab/nocabmachine/nocab/EvenMoreCommands.txt",
                true);
    }
